...
class TunePlusXL(nn.Module):
    def __init__(self, in_channels=34, n_classes=1):
        super(TunePlusXL, self).__init__()
        ...
        self.convDown4 = ConvBlock(in_channels*24,    512, kernel=3, stride=1, padding=1)

        # tail part
        self.convDown5 = ConvBlock(512, 512, kernel=3, stride=1, padding=1)
