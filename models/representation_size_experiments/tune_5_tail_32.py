...
class Tune5Tail32(nn.Module):
    def __init__(self, in_channels=11, n_classes=1):
        super(Tune5Tail32, self).__init__()
        ...
        self.transposedConv6 = nn.ConvTranspose1d(in_channels * 16, in_channels * 8, kernel_size=3, stride=stride,
                                                  padding=padding)
        self.transposedConv7 = nn.ConvTranspose1d(in_channels * 8, in_channels * 4, kernel_size=3, stride=stride,
                                                  padding=padding)
        self.transposedConv8 = nn.ConvTranspose1d(in_channels * 4, in_channels * 2, kernel_size=3, stride=stride,
                                                  padding=padding)
        self.transposedConv9 = nn.ConvTranspose1d(in_channels * 2, in_channels * 1, kernel_size=3, stride=stride,
                                                  padding=padding)
        ...
        self.convDown3 = ConvBlock(in_channels * 12, 32, kernel=3, stride=1, padding=1)
        self.convDown4 = ConvBlock(in_channels * 16 + 32, 32, kernel=3, stride=1, padding=1)

        # tail part
        self.convDown5 = ConvBlock(32, 32, kernel=3, stride=1, padding=1)
        self.convDown6 = ConvBlock(32, 32, kernel=3, stride=1, padding=1)
        self.convDown7 = ConvBlock(32, 32, kernel=3, stride=1, padding=1)
        self.convDown8 = ConvBlock(32, 32, kernel=3, stride=1, padding=1)
        self.convDown9 = ConvBlock(32, 32, kernel=3, stride=1, padding=1)
