...
class Tune5Tail128(nn.Module):
    def __init__(self, in_channels=11, n_classes=1):
        super(Tune5Tail128, self).__init__()
        ...
        self.convDown4 = ConvBlock(in_channels*24,    128, kernel=3, stride=1, padding=1)

        # tail part
        self.convDown5 = ConvBlock(128, 128, kernel=3, stride=1, padding=1)
        self.convDown6 = ConvBlock(128, 128, kernel=3, stride=1, padding=1)
        self.convDown7 = ConvBlock(128, 128, kernel=3, stride=1, padding=1)
        self.convDown8 = ConvBlock(128, 128, kernel=3, stride=1, padding=1)
        self.convDown9 = ConvBlock(128, 128, kernel=3, stride=1, padding=1)
