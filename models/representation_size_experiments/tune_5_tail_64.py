...
class Tune5Tail64(nn.Module):
    def __init__(self, in_channels=11, n_classes=1):
        super(Tune5Tail64, self).__init__()
        ...
        self.convDown3 = ConvBlock(in_channels*12,       64, kernel=3, stride=1, padding=1)
        self.convDown4 = ConvBlock(in_channels*16+64,    64, kernel=3, stride=1, padding=1)

        # tail part
        self.convDown5 = ConvBlock(64, 64, kernel=3, stride=1, padding=1)
        self.convDown6 = ConvBlock(64, 64, kernel=3, stride=1, padding=1)
        self.convDown7 = ConvBlock(64, 64, kernel=3, stride=1, padding=1)
        self.convDown8 = ConvBlock(64, 64, kernel=3, stride=1, padding=1)
        self.convDown9 = ConvBlock(64, 64, kernel=3, stride=1, padding=1)
