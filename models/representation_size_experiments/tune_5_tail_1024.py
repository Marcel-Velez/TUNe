...
class Tune5Tail1024(nn.Module):
    def __init__(self, in_channels=11, n_classes=1):
        super(Tune5Tail1024, self).__init__()
        ...
        self.convDown6 = ConvBlock(in_channels*32, in_channels*64, kernel=3, stride=1, padding=1)
        self.convDown7 = ConvBlock(in_channels*64, 1024, kernel=3, stride=1, padding=1)
        self.convDown8 = ConvBlock(1024, 1024, kernel=3, stride=1, padding=1)
        self.convDown9 = ConvBlock(1024, 1024, kernel=3, stride=1, padding=1)
