...
class Tune4Tail(nn.Module):
    def __init__(self, in_channels=13, n_classes=1):
        super(Tune4Tail, self).__init__()
        ...
        self.convDown8 = ConvBlock(in_channels*32, 512, kernel=3, stride=1, padding=1)
