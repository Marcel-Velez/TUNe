...
class Tune5TailFree(nn.Module):
    def __init__(self, in_channels=28, n_classes=1, eval_layer=None):
        super(Tune5TailFree, self).__init__()
        ...
        # extra tail layers
        self.convDown5 = ConvBlock(in_channels*16, 512, kernel=3, stride=1, padding=1)
        self.convDown6 = ConvBlock(512, 512, kernel=3, stride=1, padding=1)
        self.convDown7 = ConvBlock(512, 512, kernel=3, stride=1, padding=1)
        self.convDown8 = ConvBlock(512, 512, kernel=3, stride=1, padding=1)
        self.convDown9 = ConvBlock(512, 512, kernel=3, stride=1, padding=1)
